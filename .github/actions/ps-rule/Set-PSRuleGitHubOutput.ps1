...
Reference: https://github.com/Azure/ResourceModules/blob/main/utilities/pipelines/PSRuleValidation/Set-PSRuleGitHubOutput.ps1
...
function Set-PSRuleGitHubOutput {
    ...
    if (-not (Test-Path $inputFilePath)) {
        ...
        Out-File -FilePath $outputFilePath -NoClobber -InputObject $header -Force
